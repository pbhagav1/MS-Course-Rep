...
public class TestingFigureStrategy {
    private static String figureDecorator;
    public static void main(String args[]) throws InterruptedException{
        ...
        loop = 0;
        figureDecorator = "Hat";
        FigureDecoratorFactory fd = getFigureDecoratorFactory();
        figuresList.add(fd.getFigure("SQUARE"));
        Thread.sleep(500);
        figuresList.add(fd.getFigure("CIRCLE"));
        Thread.sleep(500);
        figuresList.add(fd.getFigure("TRIANGLE"));
        Thread.sleep(500);
        figuresList.add(fd.getFigure("HEXAGON"));
        Thread.sleep(500);
    ...
    public static FigureDecoratorFactory getFigureDecoratorFactory (){
        FigureDecoratorFactory fd;
        if (figureDecorator.equals("Hat")){
            fd = FigureWithHatFactory.getFigureWithHatFactory();
        }
        else{
            fd = FigureWithUmbFactory.getFigureWithUmbFactory();
        }
        return fd;
    }
}
